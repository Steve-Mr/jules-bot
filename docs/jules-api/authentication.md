...
- **”API key not valid”**: Verify you copied the entire key without extra spaces. Check that the key hasn’t been revoked. Generate a new key if needed.
- **”Permission denied”**: Verify your account has access to Jules. Check that you have access to the requested resources (sessions, sources).
- **“Quota exceeded”**: You may have hit rate limits.
